...
export default function FacultyProfilePage() {
  ...
  async function handleLogout() {
    ...
    ["role", "user", "departmentName"].forEach((k) =>
        ...
        <div className="px-5 sm:px-8 py-6 max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 sm:p-8 flex items-center gap-5 sm:gap-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-[20px] sm:text-[24px] font-bold text-slate-800 tracking-tight leading-tight mb-1">
                {user.name || "Faculty"}
              </p>
          ...
          <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 sm:p-8">
            <p className="text-[14px] font-bold text-slate-800 mb-5">
              Account Details
            </p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-[13px] font-bold text-slate-700 outline-none focus:bg-white focus:border-[#00a859] focus:ring-2 focus:ring-[#00a859]/10 transition shadow-inner"
                  />
                  <button
                    type="button"
          ...
          >
            <LogOut
              size={16}
              className="text-slate-400 group-hover:text-[#e31e24] transition-colors"
            />
            Sign Out
          </button>
        </div>
